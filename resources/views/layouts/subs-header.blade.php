...
<div class="w3-sidebar w3-bar-block w3-border-right" style="width:0px" id="mySidebar">
  ...
  <button onclick="w3_close()" class="w3-bar-item w3-large">Close &times;</button>
                ...
                <a  class="w3-bar-item w3-button hover-side" href="/investment">Investment</a>
                ...
                <a  class="w3-bar-item w3-button hover-side" href="/dashboard">Dashboard</a>
                <a  class="w3-bar-item w3-button hover-side" href="/jimtacoin">PV Point</a>
             ...
             <div class="dropdown px-1">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="{{route('codef')}}">
                            <div class="d-flex align-items-center">
                                <p class="mr-3 mb-0">Buy Referal Code</p>
                            </div>      
                        </a>
                        ...
                        <a class="dropdown-item" href="{{route('investment')}}">
                            <div class="d-flex align-items-center">
                                <p class="mr-3 mb-0">Make Investment</p>
                            </div>      
                        </a>
                    </div>
                </div>
        ...
        <div class="container h-100">
            ...
            @endif
                ...
                <a class="nav-button_sec bl_lf  bl_rg d-flex align-items-center px-3" href="/user/account">
                    <i class="fa fa-user mx-1" aria-hidden="true"></i><p class="m-0 d-flex align-items-center color-yellow-tp"><span class="user-i-col m-0">User ID</span> :{{auth()->user()->id}}</p>
                </a>
