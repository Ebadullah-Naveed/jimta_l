            ...
            <div class="col-12 col-lg-12">
                <div class="row">
                    <div class="col-12">
                        <div class="text-center text-150">
                            ...
                            <span class="text-default-d3">Jimta</span>
                        </div>
                    </div>
                </div>
                <!-- .row -->
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-1"><i class="fa fa-phone fa-flip-horizontal text-secondary"></i> <b class="text-600">{{$order->user->phone}}</b></div>
                        </div>
                    </div>
                    <!-- /.col -->
                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        @foreach($order->order_item as $key => $items)
                        <div class="row mb-2 mb-sm-0 py-25">
                            <div class="d-none d-sm-block col-1">{{$key+1}}</div>
                            <div class="col-9 col-sm-5">{{\App\Models\Product::where('id',$items->product_id)->value('title')}}</div>
                            <div class="d-none d-sm-block col-2">{{$item->quantity}}</div>
                            <div class="d-none d-sm-block col-2 text-95">{{\App\Models\Product::where('id',$items->product_id)->value('price')}}</div>
                            <div class="col-2 text-secondary-d2">{{\App\Models\Product::where('id',$items->product_id)->value('price') * $item->quantity}}</div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                            <div class="row my-2">
                                ...
                                <div class="col-5">
                                    <span class="text-120 text-secondary-d1">${{$order->total}}</span>
                                </div>
                            </div>
